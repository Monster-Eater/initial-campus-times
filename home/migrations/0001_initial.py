# Generated by Django 4.2 on 2023-04-16 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=30, verbose_name='Contact Phine')),
                ('web', models.URLField(verbose_name='Website Address')),
                ('wemail_address', models.EmailField(max_length=254, verbose_name='Email Address')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
